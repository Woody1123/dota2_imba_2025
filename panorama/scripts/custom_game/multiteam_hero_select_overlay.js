...
function UpdatePlayer(teamPanel, playerId) {
    ...
    if (playerInfo.player_selected_hero !== "") {
        ...
        playerPortrait.SetImage("file://{images}/custom_game/portrait/" + playerId.toString() + ".jpg");
    }
...
function UpdateTimer() {
    ...
    //  FindDotaHudElement("StrategyPanel").visible = 0;
    //  FindDotaHudElement("StartingItems").visible = 0;
    //  FindDotaHudElement("BattlePassHeroData").visible = 0;
