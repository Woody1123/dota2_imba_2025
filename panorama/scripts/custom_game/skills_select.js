...
function select_skills(data) {
    ...
    for (var index = 1; index <= data[2]; index++) {
        ...
        if (aut != null) {
            ...
            add_author_events(t1,
                (n1 == null || n1 == "") ? $.Localize("#No_Skills_Select") : n1,
                (p1 == null || p1 == "") ? "file://{images}/heroes/" + hero_name + ".png" : p1,
                (tip1 == null || tip1 == "") ? $.Localize("#No_Skills_Desc") : tip1
            );
        }
        */
