...
function modifier_imba_rubick_fade_bolt_debuff:IsPurgable() 		return false end
...
function modifier_imba_rubick_fade_bolt_debuff:DeclareFunctions()  return {MODIFIER_PROPERTY_BASEDAMAGEOUTGOING_PERCENTAGE,MODIFIER_PROPERTY_SPELL_AMPLIFY_PERCENTAGE,MODIFIER_PROPERTY_CAST_RANGE_BONUS_STACKING} end
function modifier_imba_rubick_fade_bolt_debuff:RemoveOnDeath()  return false end
function modifier_imba_rubick_fade_bolt_debuff:GetAttributes()
...
function modifier_imba_rubick_fade_bolt_debuff:GetModifierCastRangeBonusStacking() return -self:GetAbility():GetSpecialValueFor("cast_range") end