...
function modifier_imba_rubick_arcane_supremacy:DeclareFunctions() return {MODIFIER_PROPERTY_SPELL_AMPLIFY_PERCENTAGE, MODIFIER_PROPERTY_CAST_RANGE_BONUS_STACKING} end
...
function modifier_imba_rubick_arcane_supremacy:GetModifierCastRangeBonusStacking() return self:GetAbility():GetSpecialValueFor("cast_range") end
