...
LinkLuaModifier("modifier_dlnec_reaper_judge2", "dl/dlnec/dlnec_reaper/modifier_dlnec_reaper_judge", LUA_MODIFIER_MOTION_NONE)
...
function dlnec_reaper:OnSpellStart()
    ...
    target:AddNewModifier(caster, self, "modifier_dlnec_reaper_judge", {duration = self:GetSpecialValueFor("reaper_stun")})
	target:AddNewModifier(caster, self, "modifier_dlnec_reaper_judge2", {duration = self:GetSpecialValueFor("reaper_stun")+0.3})
