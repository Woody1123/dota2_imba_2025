...
function Awake()
    ...
    HeroWearable = LoadKeyValues("scripts/npc/kv/hero_wearable.kv")
	...
	LinkLuaModifier("modifier_illusion_moon_shard_buff", "modifier/rune/modifier_illusion_moon_shard_buff.lua", LUA_MODIFIER_MOTION_NONE)
    ...
    LinkLuaModifier("modifier_hero_wearable", "modifier/player/modifier_hero_wearable.lua", LUA_MODIFIER_MOTION_NONE)
	...
	LinkLuaModifier("modifier_witch_doctor_up", "modifier/modifier_witch_doctor_up.lua", LUA_MODIFIER_MOTION_NONE )
	LinkLuaModifier("modifier_witch_doctor_death_ward_up", "modifier/modifier_witch_doctor_up.lua", LUA_MODIFIER_MOTION_NONE )
	LinkLuaModifier("modifier_morphling", "modifier/modifier_morphling.lua", LUA_MODIFIER_MOTION_NONE )
   ...
   -- LinkLuaModifier("modifier_generic_knockback_lua", "mb/generic/modifier_generic_knockback_lua.lua", LUA_MODIFIER_MOTION_BOTH )
    ...
    LinkLuaModifier("modifier_imba_test", "modifier/old_imba/modifier_dummy_thinker.lua", LUA_MODIFIER_MOTION_NONE )
    LinkLuaModifier("modifier_imba_test_1","modifier/old_imba/modifier_dummy_thinker.lua", LUA_MODIFIER_MOTION_NONE )
