...
function modifier_imba_frost_arrows_shard:OnCreated()
	...
	self.pfx2 = ParticleManager:SafeCreateParticle("particles/units/heroes/hero_drow/drow_hypothermia_counter_stack.vpcf", PATTACH_OVERHEAD_FOLLOW, self:GetParent())
