...
LinkLuaModifier("imba_ogre_magi_fireblast_att", "linken/hero_ogre_magi.lua", LUA_MODIFIER_MOTION_NONE)

function imba_ogre_magi_fireblast_ignite:IsHiddenWhenStolen()
    return false
end
function imba_ogre_magi_fireblast_ignite:IsRefreshable()
    return true
end
function imba_ogre_magi_fireblast_ignite:IsStealable()
    return true
end
function imba_ogre_magi_fireblast_ignite:GetCastRange()
    return self:GetSpecialValueFor("cast_distance") + self:GetCaster():TG_GetTalentValue("special_bonus_imba_ogre_magi_6")
end

function imba_ogre_magi_fireblast_ignite:GetIntrinsicModifierName()
    return "imba_ogre_magi_fireblast_att"
end
...
--25级天赋攻击触发
imba_ogre_magi_fireblast_att = class({})

function imba_ogre_magi_fireblast_att:IsPassive()
    return true
end

function imba_ogre_magi_fireblast_att:IsPurgable()
    return false
end

function imba_ogre_magi_fireblast_att:IsPurgeException()
    return false
end

function imba_ogre_magi_fireblast_att:IsHidden()
    return true
end

function imba_ogre_magi_fireblast_att:DeclareFunctions()
    return
    {
...
function imba_ogre_magi_fireblast_att:OnCreated()
...
function imba_ogre_magi_fireblast_att:OnRefresh()
    self:OnCreated()
end

function imba_ogre_magi_fireblast_att:OnAttackLanded(tg)
    if tg.target:IsBuilding() or tg.target:IsMagicImmune() or tg.attacker:PassivesDisabled() then
        return
    end
    if self.parent:TG_HasTalent("special_bonus_imba_ogre_magi_4") then
        self.chl = self:GetParent():TG_GetTalentValue("special_bonus_imba_ogre_magi_4")
        if tg.attacker == self.parent and RollPseudoRandomPercentage(self.chl, 0, self.parent)  then
            self.parent:SetCursorCastTarget(tg.target)
            self.ability:OnSpellStart()
            local MultiAbility=self.parent:FindModifierByName("modifier_imba_multicast_passive")
            if MultiAbility~=nil then
				local ab = MultiAbility:GetAbility()
				if ab and ab:IsCooldownReady() then
					ab:StartCooldown(ab:GetCooldown(-1) * self:GetParent():GetCooldownReduction())
					tg.ability=self.ability
					tg.unit=self.parent
					tg.dismultiflag=true
				end
            end
        end
    end
...
function modifier_imba_ogre_magi_fireblast_ignite_debuff:IsDebuff()
    return true
end
function modifier_imba_ogre_magi_fireblast_ignite_debuff:IsHidden()
    return false
end
function modifier_imba_ogre_magi_fireblast_ignite_debuff:IsPurgable()
    --return not self:GetCaster():TG_HasTalent("special_bonus_imba_ogre_magi_8")
    return true
end
function modifier_imba_ogre_magi_fireblast_ignite_debuff:IsPurgeException()
    --return not self:GetCaster():TG_HasTalent("special_bonus_imba_ogre_magi_8")
    return true
end
function modifier_imba_ogre_magi_fireblast_ignite_debuff:DeclareFunctions()
    return { MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE, MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT }
end
function modifier_imba_ogre_magi_fireblast_ignite_debuff:GetEffectName()
    return "particles/units/heroes/hero_ogre_magi/ogre_magi_ignite_debuff.vpcf"
end
function modifier_imba_ogre_magi_fireblast_ignite_debuff:GetEffectAttachType()
    return PATTACH_ABSORIGIN_FOLLOW
end
function modifier_imba_ogre_magi_fireblast_ignite_debuff:GetModifierMoveSpeedBonus_Percentage()
    return (0 - self:GetAbility():GetSpecialValueFor("move_slow") * self:GetStackCount())
end
function modifier_imba_ogre_magi_fireblast_ignite_debuff:GetModifierAttackSpeedBonus_Constant()
    return (0 - self:GetAbility():GetSpecialValueFor("attack_slow") * self:GetStackCount())
end
...
function imba_ogre_magi_Bloodlust:IsHiddenWhenStolen()
    return false
end
function imba_ogre_magi_Bloodlust:IsRefreshable()
    return true
end
function imba_ogre_magi_Bloodlust:IsStealable()
    return true
end
function imba_ogre_magi_Bloodlust:OnSpellStart(scepter)
    ...
    if target:IsAlive() then
        ...
        local buff = target:AddNewModifier(caster, self, "modifier_imba_ogre_magi_bloodlust_c", { duration = self:GetSpecialValueFor("buff_duration")  })
...
function modifier_imba_ogre_magi_bloodlust_c:IsDebuff()
    return false
end
function modifier_imba_ogre_magi_bloodlust_c:IsHidden()
    return true
end
function modifier_imba_ogre_magi_bloodlust_c:IsPurgable()
    return true
end
function modifier_imba_ogre_magi_bloodlust_c:IsPurgeException()
    return true
end
function modifier_imba_ogre_magi_bloodlust_c:GetAttributes()
    return MODIFIER_ATTRIBUTE_MULTIPLE + MODIFIER_ATTRIBUTE_IGNORE_INVULNERABLE
end

modifier_imba_ogre_magi_bloodlust = class({})

function modifier_imba_ogre_magi_bloodlust:IsDebuff()
    return false
end
function modifier_imba_ogre_magi_bloodlust:IsHidden()
    return false
end
function modifier_imba_ogre_magi_bloodlust:IsPurgable()
    return true
end
function modifier_imba_ogre_magi_bloodlust:IsPurgeException()
    return true
end
function modifier_imba_ogre_magi_bloodlust:DeclareFunctions()
    return { MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE, MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT, MODIFIER_PROPERTY_PREATTACK_BONUS_DAMAGE, MODIFIER_PROPERTY_SPELL_AMPLIFY_PERCENTAGE }
end
...
function modifier_imba_ogre_magi_bloodlust:GetEffectName()
    return "particles/units/heroes/hero_ogre_magi/ogre_magi_bloodlust_buff.vpcf"
end
function modifier_imba_ogre_magi_bloodlust:GetEffectAttachType()
    return PATTACH_ABSORIGIN_FOLLOW
end
...
function imba_ogre_magi_focus:IsHiddenWhenStolen()
    return true
end
function imba_ogre_magi_focus:IsRefreshable()
    return false
end
function imba_ogre_magi_focus:IsStealable()
    return false
end
function imba_ogre_magi_focus:OnSpellStart()
    ...
    if not caster:TG_HasTalent("special_bonus_imba_ogre_magi_7") then
        if PseudoRandom:RollPseudoRandom(self, self:GetSpecialValueFor("rd")) then
            --根据几率
...
function modifier_imba_ogre_magi_focus_m_b:IsDebuff()
    return false
end
function modifier_imba_ogre_magi_focus_m_b:IsHidden()
    return true
end
function modifier_imba_ogre_magi_focus_m_b:IsPurgable()
    return false
end
function modifier_imba_ogre_magi_focus_m_b:IsPurgeException()
    return false
end
function modifier_imba_ogre_magi_focus_m_b:GetAttributes()
    return MODIFIER_ATTRIBUTE_MULTIPLE + MODIFIER_ATTRIBUTE_IGNORE_INVULNERABLE
end

modifier_imba_ogre_magi_focus_m = class({})

function modifier_imba_ogre_magi_focus_m:IsDebuff()
    return false
end
function modifier_imba_ogre_magi_focus_m:IsHidden()
    return false
end
function modifier_imba_ogre_magi_focus_m:IsPurgable()
    return true
end
function modifier_imba_ogre_magi_focus_m:IsPurgeException()
    return true
end
function modifier_imba_ogre_magi_focus_m:GetTexture()
    return "imba_ogre_magi_focus2_2"
end
function modifier_imba_ogre_magi_focus_m:DeclareFunctions()
    return { MODIFIER_EVENT_ON_TAKEDAMAGE, MODIFIER_PROPERTY_CAST_RANGE_BONUS_STACKING }
end
function modifier_imba_ogre_magi_focus_m:GetModifierCastRangeBonusStacking()
    return (self:GetAbility():GetSpecialValueFor("cast_range_bonus") * self:GetStackCount())
end
...
function modifier_imba_ogre_magi_focus_p_b:IsDebuff()
    return false
end
function modifier_imba_ogre_magi_focus_p_b:IsHidden()
    return true
end
function modifier_imba_ogre_magi_focus_p_b:IsPurgable()
    return false
end
function modifier_imba_ogre_magi_focus_p_b:IsPurgeException()
    return false
end
function modifier_imba_ogre_magi_focus_p_b:GetAttributes()
    return MODIFIER_ATTRIBUTE_MULTIPLE + MODIFIER_ATTRIBUTE_IGNORE_INVULNERABLE
end

modifier_imba_ogre_magi_focus_p = class({})

function modifier_imba_ogre_magi_focus_p:IsDebuff()
    return false
end
function modifier_imba_ogre_magi_focus_p:IsHidden()
    return false
end
function modifier_imba_ogre_magi_focus_p:IsPurgable()
    return true
end
function modifier_imba_ogre_magi_focus_p:IsPurgeException()
    return true
end
function modifier_imba_ogre_magi_focus_p:DeclareFunctions()
    return { MODIFIER_EVENT_ON_TAKEDAMAGE, MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT }
end
function modifier_imba_ogre_magi_focus_p:GetModifierAttackSpeedBonus_Constant()
    return (self:GetAbility():GetSpecialValueFor("attack_speed_bonus") * self:GetStackCount())
end
...
function modifier_imba_ogre_magi_focus_check:IsDebuff()
    return false
end
function modifier_imba_ogre_magi_focus_check:IsHidden()
    return true
end
function modifier_imba_ogre_magi_focus_check:IsPurgable()
    return false
end
function modifier_imba_ogre_magi_focus_check:IsPurgeException()
    return false
end
...
function modifier_imba_ogre_magi_focus_check_animation:IsHidden()
    return true
end
...
function imba_ogre_magi_multicast:IsStealable()
    return false
end
...
function modifier_multicast_attack_range:IsDebuff()
    return false
end
function modifier_multicast_attack_range:IsHidden()
    return true
end
function modifier_multicast_attack_range:IsPurgable()
    return false
end
function modifier_multicast_attack_range:IsPurgeException()
    return false
end
function modifier_multicast_attack_range:DeclareFunctions()
    return { MODIFIER_PROPERTY_ATTACK_RANGE_BONUS }
end
function modifier_multicast_attack_range:GetModifierAttackRangeBonus()
    return 10000
end

function imba_ogre_magi_multicast:GetIntrinsicModifierName()
    return "modifier_imba_multicast_passive"
end
function imba_ogre_magi_multicast:GetAbilityTextureName()
    return "ogre_magi_multicast_" .. self:GetCaster():GetModifierStackCount("modifier_imba_multicast_passive", nil)
end
function imba_ogre_magi_multicast:ResetToggleOnRespawn()
    return false
end
...
function modifier_imba_multicast_passive:IsDebuff()
    return false
end
function modifier_imba_multicast_passive:IsHidden()
    return true
end
function modifier_imba_multicast_passive:IsPurgable()
    return false
end
function modifier_imba_multicast_passive:IsPurgeException()
    return false
end
function modifier_imba_multicast_passive:AllowIllusionDuplicate()
    return false
end
function modifier_imba_multicast_passive:DeclareFunctions()
    return {
        MODIFIER_EVENT_ON_ATTACK_LANDED,
        MODIFIER_EVENT_ON_ABILITY_FULLY_CAST, MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE }
end
function modifier_imba_multicast_passive:GetModifierPercentageCooldown()
    return (self:GetAbility():GetSpecialValueFor("cdr_pct"))
end
...
function modifier_imba_multicast_passive:OnAttackLanded(keys)
    ...
    if keys.attacker ~= self:GetParent() or self:GetParent():IsIllusion() or not self:GetAbility():IsCooldownReady() or not keys.target:IsAlive() or keys.attacker:PassivesDisabled() then
        return
    end
    ...
    local chance_2 = self:GetAbility():GetSpecialValueFor("multicast_2")
    local chance_3 = self:GetAbility():GetSpecialValueFor("multicast_3")
    local chance_4 = self:GetAbility():GetSpecialValueFor("multicast_4")
    if self:GetParent():HasModifier("modifier_imba_ogre_magi_focus_check_animation") then
        ...
        chance_2 = self:GetAbility():GetSpecialValueFor("multicast_2") + self:GetCaster():FindAbilityByName("imba_ogre_magi_focus"):GetSpecialValueFor("multicast")
        chance_3 = self:GetAbility():GetSpecialValueFor("multicast_3") + self:GetCaster():FindAbilityByName("imba_ogre_magi_focus"):GetSpecialValueFor("multicast")
        chance_4 = self:GetAbility():GetSpecialValueFor("multicast_4") + self:GetCaster():FindAbilityByName("imba_ogre_magi_focus"):GetSpecialValueFor("multicast")
    end
    local multicast = 0
...
local NoMultiCastItems = {
    ...
    ["echo_stomp_spirit"] = true,
    ["ancestral_spirit"] = true,
    ["ra_roll_out"]=true,--骑乘，以免上上下下
    ["fiery_soul"]=true,
    ["imba_storm_spirit_ball_lightning"]=true,
    ["item_imba_refreshstone"]=true,
    ["sun_ray"]=true,
	["item_neutral_lvlup"]=true,
	["item_neutral_change"]=true,
	["item_bag_of_gold"]=true,
	["imba_razor_eye_of_the_storm"] = true,
	["serpent_ward"] = true,
	["ambush_kill"] = true,
	["imba_nyx_assassin_burrow"] = true,
	["imba_nyx_assassin_unburrow"]  = true,
	["imba_shadow_demon_disruption"]  = true,
	["reverse_polarity"]  = true,
	["imba_mirana_arrow"]  = true,
	--["zuus_thundergods_wrath"]  = true,
	["earth_splitter"] = true,
	["imba_tidehunter_coming"] = true,
	["imba_grimstroke_dark_portrait"] = true,
	["guardian_angel_new"] = true,
	["imba_luna_eclipse"] = true,
	["item_refresher"] = true,
	["meat_hook"] = true,
	--["imba_tidehunter_ravage"] = true,	
}
...
function modifier_imba_multicast_passive:OnAbilityFullyCast(keys)
    ...
    if self.nocast or keys.unit ~= self:GetParent() or keys.ability:IsToggle() or self:GetParent():PassivesDisabled() then
        return
    end
    ...
    if multicast ~= 0 and multicast ~= 2 and ability1 and caster:TG_HasTalent("special_bonus_imba_ogre_magi_5") and keys.dismultiflag~=true then
...
function modifier_imba_multicast_passive:DoMultiTargetAbility(caster, target, ability, times)
    --self:GetAbility():StartCooldown(self:GetAbility():GetCooldown(-1) * self:GetParent():GetCooldownReduction())
    for i = 1, times - 1 do
		if  self:Checkf(caster, ability ,target) then
...
function modifier_imba_multicast_passive:DoMultiPositionAbility(caster, pos, ability, times)
    for i = 1, times - 1 do
	if self:Checkf(caster, ability, nil) then
        Timers:CreateTimer(i * self:GetAbility():GetSpecialValueFor("multicast_delay"), function()
				self.nocast = true
...
function modifier_imba_multicast_passive:Checkf(caster, ability, target)
	if target~=nil then
	...
	if not ability:IsNull() then
		if ability:IsItem() then
				if caster:HasItemInInventory(ability:GetName()) then
					return true
				end
			else
