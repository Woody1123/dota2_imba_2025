imba_chemical_rage=class({})
LinkLuaModifier("modifier_imba_chemical_rage_buff", "happycat/hero_alchemist/imba_chemical_rage.lua", LUA_MODIFIER_MOTION_NONE)
function imba_chemical_rage:GetGoblinsGreedBet(hero)
...
function imba_chemical_rage:IsHiddenWhenStolen()
    return false
end
function imba_chemical_rage:IsStealable()
    return true
end
function imba_chemical_rage:IsRefreshable()
    return true
end
function imba_chemical_rage:Init()
...
modifier_imba_chemical_rage_buff=class({})
function modifier_imba_chemical_rage_buff:IsDebuff()
      return false
end
function modifier_imba_chemical_rage_buff:IsPurgable()
      return false
end
function modifier_imba_chemical_rage_buff:IsPurgeException()
      return false
end
function modifier_imba_chemical_rage_buff:AllowIllusionDuplicate()
      return false
end
function modifier_imba_chemical_rage_buff:OnCreated()
...
function modifier_imba_chemical_rage_buff:OnRefresh()
      self:OnCreated()
end
function modifier_imba_chemical_rage_buff:DeclareFunctions()
	return
		{
...
function modifier_imba_chemical_rage_buff:OnAttackLanded(tg)
...
function modifier_imba_chemical_rage_buff:GetModifierBaseAttackTimeConstant()
	return self.base_attack_time-self.parent:TG_GetTalentValue("special_bonus_alchemist_7")
end
function modifier_imba_chemical_rage_buff:GetModifierMoveSpeedBonus_Constant()
    return self.bonus_movespeed
end
function modifier_imba_chemical_rage_buff:GetModifierConstantHealthRegen()
    return self.bonus_health_regen
end
function modifier_imba_chemical_rage_buff:GetModifierPreAttack_BonusDamage()
    return self.gold*self.att
end
function modifier_imba_chemical_rage_buff:GetModifierPhysicalArmorBonus( )
...
function modifier_imba_chemical_rage_buff:GetModifierStatusResistanceStacking( )
...
function modifier_imba_chemical_rage_buff:GetActivityTranslationModifiers()
    return "imba_chemical_rage"
end
function modifier_imba_chemical_rage_buff:GetAttackSound()
    return "Hero_Alchemist.ChemicalRage.Attack"
end
function modifier_imba_chemical_rage_buff:CheckState()
