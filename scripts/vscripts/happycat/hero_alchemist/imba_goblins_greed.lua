            ...
            if tg.attacker:IsTrueHero() and  tg.unit:IsTrueHero() then 
                if   tg.attacker:GetTeamNumber()==self.team  then
                  if  tg.attacker:FindModifierByName('modifier_imba_goblins_greed_pa') then 
                        ...
                        local fx = ParticleManager:SafeCreateParticle("particles/tgp/alchemist/msg_gold.vpcf", PATTACH_ABSORIGIN,  tg.attacker)
                        ...
                        local fx2 = ParticleManager:SafeCreateParticle("particles/tgp/alchemist/msg_gold.vpcf", PATTACH_ABSORIGIN, self.caster)
