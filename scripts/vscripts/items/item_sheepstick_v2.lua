...
function modifier_item_sheepstick_v2_debuff:GetModifierPhysicalArmorBase_Percentage()
    return 0
end
function modifier_item_sheepstick_v2_debuff:GetModifierPhysicalArmorBonus()
    return self.ar
end
