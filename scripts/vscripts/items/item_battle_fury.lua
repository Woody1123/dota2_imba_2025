...
function item_battle_fury:GetAOERadius() return 300
end
function item_battle_fury:OnSpellStart()
    ...
    GridNav:DestroyTreesAroundPoint(pos,300,false)
		...
		local eni = Entities:FindAllInSphere(pos,300)
		for _,v in pairs(eni) do
			if v:GetName() == "npc_dota_treant_eyes" then
				UTIL_Remove(v)
			end	
