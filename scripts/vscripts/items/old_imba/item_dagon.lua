LinkLuaModifier("modifier_imba_dagon_passive", "items/old_imba/item_dagon.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_imba_dagon_passive:GetModifierBonusStats_Intellect() return self.bonus_all_stats+ self.bonus_intellect end
function modifier_imba_dagon_passive:GetModifierBonusStats_Agility() return self.bonus_all_stats end
function modifier_imba_dagon_passive:GetModifierBonusStats_Strength() return self.bonus_all_stats end
function modifier_imba_dagon_passive:GetModifierPreAttack_BonusDamage() return self.bonus_damage end
...
function item_imba_dagon_2:Precache( context )
	PrecacheResource( "particle", "particles/items_fx/dagon.vpcf", context )
end
...
function item_imba_dagon_3:Precache( context )
	PrecacheResource( "particle", "particles/items_fx/dagon.vpcf", context )
end
...
function item_imba_dagon_4:Precache( context )
	PrecacheResource( "particle", "particles/items_fx/dagon.vpcf", context )
end
...
function item_imba_dagon_5:Precache( context )
	PrecacheResource( "particle", "particles/items_fx/dagon.vpcf", context )
end
...
function item_imba_dagon_6:Precache( context )
	PrecacheResource( "particle", "particles/items_fx/dagon.vpcf", context )
end
...
function item_imba_dagon_7:Precache( context )
...
function item_imba_dagon_8:Precache( context )
	PrecacheResource( "particle", "particles/econ/events/ti5/dagon_ti5.vpcf", context )
end
...
function item_imba_dagon_9:Precache( context )
	PrecacheResource( "particle", "particles/econ/events/ti5/dagon_lvl2_ti5.vpcf", context )
end
...
function item_imba_dagon_10:Precache( context )
