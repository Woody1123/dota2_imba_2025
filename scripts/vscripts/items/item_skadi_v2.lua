...
function item_skadi_v2:OnSpellStart()
    ...
    local fx = ParticleManager:SafeCreateParticle("particles/econ/items/ancient_apparition/aa_blast_ti_5/ancient_apparition_ice_blast_explode_ti5.vpcf", PATTACH_CUSTOMORIGIN, caster)
