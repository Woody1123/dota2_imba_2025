...
function modifier_item_octarine_core_v2_buff:OnCreated()
    ...
    self.blood=self.ability:GetSpecialValueFor("blood")*0.01
end
...
function modifier_item_octarine_core_v2_buff:GetModifierPercentageCooldown()
    return 25
end
