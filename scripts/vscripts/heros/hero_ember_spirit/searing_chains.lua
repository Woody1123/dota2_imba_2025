...
function searing_chains:OnSpellStart()
	...
	local pf = ParticleManager:SafeCreateParticle("particles/units/heroes/hero_ember_spirit/ember_spirit_searing_chains_cast.vpcf", PATTACH_ABSORIGIN_FOLLOW, caster)
    ...
    if #heroes>0 then
        ...
        for a=1,num do
			...
			local pf = ParticleManager:SafeCreateParticle("particles/units/heroes/hero_ember_spirit/ember_spirit_searing_chains_start.vpcf", PATTACH_CUSTOMORIGIN, heroes[a])
