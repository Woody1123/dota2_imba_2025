...
function nether_swap:OnSpellStart()
    ...
    if Is_Chinese_TG(caster,target) then
        ...
        local fx2 = ParticleManager:SafeCreateParticle( "particles/units/heroes/hero_vengeful/vengeful_nether_swap_target.vpcf", PATTACH_ABSORIGIN_FOLLOW, target)
        ...
        if self:GetAutoCastState() then
            ...
            FindClearSpaceForUnit( caster, tpos, true )
            FindClearSpaceForUnit( target, cpos, true )
            local fx1 = ParticleManager:SafeCreateParticle( "particles/units/heroes/hero_vengeful/vengeful_nether_swap.vpcf", PATTACH_ABSORIGIN_FOLLOW, caster)
