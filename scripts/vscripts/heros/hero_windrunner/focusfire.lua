...
function modifier_focusfire_debuff:OnRefresh()
	if IsServer() then
		...
		local particle = ParticleManager:SafeCreateParticle("particles/econ/items/windrunner/windranger_arcana/windranger_arcana_focusfire_hit.vpcf", PATTACH_ABSORIGIN_FOLLOW,self:GetCaster())
