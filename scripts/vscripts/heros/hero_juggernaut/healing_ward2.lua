...
function healing_ward2:OnSpellStart()
    ...
    local particle = ParticleManager:SafeCreateParticle("particles/units/heroes/hero_doom_bringer/doom_bringer_devour.vpcf", PATTACH_OVERHEAD_FOLLOW, caster)
    ...
    if #heros>0 then 
            for _, hero in pairs(heros) do
                if hero:IsAlive() and caster:GetOwner()==hero then 
                    ...
                    local particle2 = ParticleManager:SafeCreateParticle("particles/heros/jugg/jugg_dog.vpcf", PATTACH_ABSORIGIN_FOLLOW, hero)
...
function modifier_healing_ward2_buff:OnCreated(tg)
    ...
    local particle2 = ParticleManager:SafeCreateParticle("particles/econ/items/juggernaut/jugg_arcana/juggernaut_arcana_v2_trigger.vpcf", PATTACH_CUSTOMORIGIN, self:GetParent())
    ...
    local particle3 = ParticleManager:SafeCreateParticle("particles/econ/items/juggernaut/jugg_arcana/juggernaut_arcana_trigger.vpcf", PATTACH_CUSTOMORIGIN_FOLLOW, self:GetParent())
