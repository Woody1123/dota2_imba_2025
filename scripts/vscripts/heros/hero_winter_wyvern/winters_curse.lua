...
function winters_curse:OnSpellStart()
    ...
    if tar:TriggerSpellAbsorb(self) then
		return
	end
      ...
      local pf1 = ParticleManager:SafeCreateParticle("particles/units/heroes/hero_winter_wyvern/wyvern_winters_curse_start.vpcf", PATTACH_ABSORIGIN_FOLLOW, self.caster)
...
function modifier_winters_curse_debuff:OnCreated()
    ...
    if IsServer() then
      local pf1 = ParticleManager:SafeCreateParticle("particles/units/heroes/hero_winter_wyvern/wyvern_winters_curse.vpcf", PATTACH_ABSORIGIN_FOLLOW, self.parent)
      ...
      local pf2 = ParticleManager:SafeCreateParticle("particles/units/heroes/hero_winter_wyvern/wyvern_winters_curse_ground.vpcf", PATTACH_ABSORIGIN_FOLLOW, self.parent)
      ...
      local pf3 = ParticleManager:SafeCreateParticle("particles/units/heroes/hero_winter_wyvern/wyvern_winters_curse_overhead.vpcf", PATTACH_OVERHEAD_FOLLOW, self.parent)
      self:AddParticle(pf3, false, false, 4, false, false)
      local pf4 = ParticleManager:SafeCreateParticle("particles/units/heroes/hero_winter_wyvern/wyvern_winters_curse_beams.vpcf", PATTACH_ABSORIGIN_FOLLOW, self.parent)
