...
function modifier_trap_teleport:OnCreated(tg) 
    ...
    self:GetParent().trap_teleportfx = ParticleManager:SafeCreateParticle("particles/heros/templar_assassin/trap_teleport.vpcf", PATTACH_WORLDORIGIN, nil)
    ...
    for num=1,#pos do
        ...
        local fx2 = ParticleManager:SafeCreateParticle("particles/units/heroes/hero_templar_assassin/templar_assassin_trap_explode.vpcf", PATTACH_CUSTOMORIGIN,self:GetParent())
        ParticleManager:SetParticleControl(fx2, 0, pos[num])
        ParticleManager:ReleaseParticleIndex(fx2)
        local fx3 = ParticleManager:SafeCreateParticle("particles/heros/templar_assassin/templar_assassin_trap_portrait.vpcf", PATTACH_CUSTOMORIGIN, self:GetParent())
