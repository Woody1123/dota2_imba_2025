...
function modifier_rip_tide_pa:OnAttackLanded(tg)
    ...
    if buff:GetStackCount() >= (self.maxCount-1) then
        ...
        local p= ParticleManager:SafeCreateParticle("particles/units/heroes/hero_siren/naga_siren_riptide.vpcf", PATTACH_ABSORIGIN_FOLLOW,self:GetParent())
...
function modifier_rip_tide_buff:OnCreated(tg)
    ...
    local fx = ParticleManager:SafeCreateParticle("particles/heros/naga_siren/naga_siren_circle.vpcf", PATTACH_CUSTOMORIGIN, nil)
