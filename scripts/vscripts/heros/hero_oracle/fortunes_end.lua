...
function modifier_fortunes_end_debuff:OnCreated() 
    ...
    local p= ParticleManager:SafeCreateParticle("particles/units/heroes/hero_oracle/oracle_fortune_aoe.vpcf", PATTACH_ABSORIGIN,self:GetParent())
    ...
    local p2= ParticleManager:SafeCreateParticle("particles/units/heroes/hero_oracle/oracle_fortune_purge.vpcf", PATTACH_ABSORIGIN_FOLLOW,self:GetParent())
    ...
    local p3= ParticleManager:SafeCreateParticle("particles/units/heroes/hero_oracle/oracle_fortune_dmg.vpcf", PATTACH_ABSORIGIN,self:GetParent())
