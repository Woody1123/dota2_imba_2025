...
function ice_path:OnSpellStart()
	...
	--local pfx = ParticleManager:SafeCreateParticle( "particles/econ/items/jakiro/jakiro_ti7_immortal_head/jakiro_ti7_immortal_head_ice_path.vpcf", PATTACH_CUSTOMORIGIN, nil )
	local pfx = ParticleManager:SafeCreateParticle( "particles/units/heroes/hero_jakiro/jakiro_ice_path.vpcf", PATTACH_CUSTOMORIGIN, nil )
	...
	Timers:CreateTimer(1, function()
		...
		local p = ParticleManager:SafeCreateParticle( "particles/econ/events/ti9/high_five/high_five_impact_snow.vpcf", PATTACH_CUSTOMORIGIN, nil )
...
function modifier_imba_ice_path_thinker:OnCreated(tg)
	...
	local pfx = ParticleManager:SafeCreateParticle( "particles/units/heroes/hero_jakiro/jakiro_ice_path_b.vpcf", PATTACH_CUSTOMORIGIN, nil )
	--local pfx2 = ParticleManager:SafeCreateParticle( "particles/econ/items/jakiro/jakiro_ti7_immortal_head/jakiro_ti7_immortal_head_ice_path_b.vpcf", PATTACH_CUSTOMORIGIN, nil )
