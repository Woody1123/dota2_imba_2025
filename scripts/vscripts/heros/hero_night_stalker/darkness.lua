...
function modifier_darkness_sp:GetModifierPreAttack_BonusDamage()
...
function modifier_darkness_buff:RemoveOnDeath()
    return false
end
...
function modifier_darkness_buff:GetModifierPreAttack_BonusDamage()
