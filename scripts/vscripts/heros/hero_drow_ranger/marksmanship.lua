...
function marksmanship:OnSpellStart()
    ...
    local fx = ParticleManager:SafeCreateParticle("particles/tgp/drow/drow_m0.vpcf", PATTACH_CUSTOMORIGIN, nil)
                ...
                Timers:CreateTimer(time, function()
                    ...
                    local fx1 = ParticleManager:SafeCreateParticle("particles/units/heroes/hero_drow/drow_shard_hypo_blast.vpcf", PATTACH_CUSTOMORIGIN, nil)
                    ...
                    local fx2 = ParticleManager:SafeCreateParticle("particles/tgp/drow/drow_circle_m.vpcf", PATTACH_CUSTOMORIGIN, nil)
