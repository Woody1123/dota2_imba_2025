...
function wave_of_silence:OnSpellStart()
    ...
    local dir=cpos==pos and  TG_Direction(pos+Vector(1,1,0),cpos) or TG_Direction(pos,cpos)
    ...
    if self:GetAutoCastState() then
            ...
            Timers:CreateTimer(time, function()
                        ...
                        local fx = ParticleManager:SafeCreateParticle("particles/tgp/wind_m.vpcf", PATTACH_CUSTOMORIGIN, nil)
