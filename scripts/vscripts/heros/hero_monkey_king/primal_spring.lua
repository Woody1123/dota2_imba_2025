...
function primal_spring:OnSpellStart()
    ...
    local particle = ParticleManager:SafeCreateParticle("particles/econ/items/monkey_king/arcana/fire/monkey_king_spring_cast_arcana_fire.vpcf", PATTACH_CUSTOMORIGIN, nil)
    ...
    local particle2 = ParticleManager:SafeCreateParticle("particles/units/heroes/hero_monkey_king/monkey_king_spring_channel.vpcf", PATTACH_ABSORIGIN_FOLLOW, caster)
...
function modifier_primal_spring_motion:OnDestroy()
    if  IsServer() then
        ...
        local particle = ParticleManager:SafeCreateParticle("particles/econ/items/monkey_king/arcana/fire/monkey_king_spring_arcana_fire.vpcf", PATTACH_CUSTOMORIGIN,self:GetParent())
