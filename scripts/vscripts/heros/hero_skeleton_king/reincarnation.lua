...
function reincarnation:OnSpellStart()
    ...
    local particle = ParticleManager:SafeCreateParticle( "particles/units/heroes/hero_skeletonking/wraith_king_vampiric_aura_lifesteal.vpcf", PATTACH_OVERHEAD_FOLLOW ,target)
