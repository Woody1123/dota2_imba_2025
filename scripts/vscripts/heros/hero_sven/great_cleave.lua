...
function great_cleave:OnSpellStart()
	...
	local fx1 = ParticleManager:SafeCreateParticle( "particles/vr/player_light_godray.vpcf", PATTACH_WORLDORIGIN, nil )
	...
	local fx2 = ParticleManager:SafeCreateParticle( "particles/heros/axe/shake.vpcf", PATTACH_ABSORIGIN_FOLLOW ,caster)
	ParticleManager:ReleaseParticleIndex(fx2)
	local fx3 = ParticleManager:SafeCreateParticle( "particles/units/heroes/hero_zuus/zuus_lightning_bolt.vpcf", PATTACH_CUSTOMORIGIN, nil )
...
function modifier_great_cleave_buff:OnCreated()
	...
	local fx = ParticleManager:SafeCreateParticle( "particles/tgp/sven/sword_m.vpcf", PATTACH_WORLDORIGIN, nil )
	...
	local fx2 = ParticleManager:SafeCreateParticle( "particles/tgp/sven/sowrd_ground_m.vpcf", PATTACH_ABSORIGIN_FOLLOW  ,self:GetParent())
	self:AddParticle(fx2, false, false, 2, false, false)
	local fx3 = ParticleManager:SafeCreateParticle("particles/tgp/sven/sven_circle_m.vpcf", PATTACH_CUSTOMORIGIN, nil)
