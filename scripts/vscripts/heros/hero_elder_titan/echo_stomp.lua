...
function echo_stomp:OnSpellStart()
    ...
    local particle3= ParticleManager:SafeCreateParticle("particles/econ/items/elder_titan/elder_titan_ti7/elder_titan_echo_stomp_cast_combined_detail_ti7.vpcf", PATTACH_ABSORIGIN,caster)
    ...
    if not caster:HasModifier("modifier_ancestral_spirit_echo_stomp") then
        local  particle4= ParticleManager:SafeCreateParticle("particles/heros/elder_titan/echo_stomp_cast_combined_ti7.vpcf", PATTACH_ABSORIGIN,caster)
...
function echo_stomp:OnChannelFinish(bInterrupted)
    ...
    if not bInterrupted then
        ...
        if  RollPseudoRandomPercentage(50,0,self) then
            local particle= ParticleManager:SafeCreateParticle("particles/econ/items/elder_titan/elder_titan_ti7/elder_titan_echo_stomp_ti7.vpcf", PATTACH_ABSORIGIN,caster)
            ...
            local particle2= ParticleManager:SafeCreateParticle("particles/econ/items/elder_titan/elder_titan_ti7/elder_titan_echo_stomp_ti7_magical.vpcf", PATTACH_ABSORIGIN,caster)
        ...
        local heros = FindUnitsInRadius(
            ...
            if caster:HasScepter() then
                ...
                local particle5= ParticleManager:SafeCreateParticle("particles/units/heroes/hero_elder_titan/elder_titan_earth_splitter.vpcf", PATTACH_ABSORIGIN,caster)
