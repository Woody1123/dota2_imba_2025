...
function ancestral_spirit:OnSpellStart()
    ...
    local particle = ParticleManager:SafeCreateParticle("particles/units/heroes/hero_elder_titan/elder_titan_ancestral_spirit_cast.vpcf", PATTACH_ABSORIGIN, caster)
        ...
        if #heros<1 then
            ...
            for _, hero in pairs(heros) do
                ...
                local damageTable = {
                    ...
                    local particle = ParticleManager:SafeCreateParticle("particles/units/heroes/hero_elder_titan/elder_titan_ancestral_spirit_touch.vpcf", PATTACH_ABSORIGIN_FOLLOW, self:GetParent())
...
function modifier_ancestral_spirit_buff:OnCreated(tg)
    ...
    local particle = ParticleManager:SafeCreateParticle("particles/units/heroes/hero_elder_titan/elder_titan_ancestral_spirit_buff.vpcf", PATTACH_ABSORIGIN_FOLLOW, self:GetParent())
    ParticleManager:SetParticleControl(particle, 0, self:GetParent():GetAbsOrigin())
...
function modifier_ancestral_spirit_return:OnIntervalThink()
    ...
    if TG_Distance(self.CASTER:GetAbsOrigin(),self.CASTER:GetOwner():GetAbsOrigin()) <=150 then
        ...
        local particle = ParticleManager:SafeCreateParticle("particles/units/heroes/hero_elder_titan/elder_titan_ancestral_spirit_ambient_end.vpcf", PATTACH_ABSORIGIN_FOLLOW, self.CASTER2)
        ParticleManager:ReleaseParticleIndex(particle)
