...
function guardian_angel_new:OnSpellStart()
    ...
    local radius= caster:HasScepter() and 1400 or self:GetSpecialValueFor("radius")
	...
	unit:AddNewModifier(caster, self, "modifier_unit_remove",  {duration=duration})
