...
function launch_fire_spirit:OnProjectileHit_ExtraData(target, location,kv)
	...
	local fx = ParticleManager:SafeCreateParticle("particles/econ/items/phoenix/phoenix_ti10_immortal/phoenix_ti10_fire_spirit_ground.vpcf", PATTACH_WORLDORIGIN, nil)
