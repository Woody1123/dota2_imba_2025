...
function light_strike_array:Light(pos,isDmg)
      ...
      local fx = ParticleManager:SafeCreateParticle("particles/econ/items/lina/lina_ti7/light_strike_array_pre_ti7.vpcf", PATTACH_CUSTOMORIGIN, nil)
      ...
      local fx1 = ParticleManager:SafeCreateParticle("particles/econ/items/lina/lina_ti7/lina_spell_light_strike_array_ti7.vpcf", PATTACH_CUSTOMORIGIN, nil)
...
function modifier_light_strike_array_th:OnIntervalThink()
      ...
      local fx = ParticleManager:SafeCreateParticle( "particles/tgp/lina/laser_m.vpcf", PATTACH_CUSTOMORIGIN, nil)
