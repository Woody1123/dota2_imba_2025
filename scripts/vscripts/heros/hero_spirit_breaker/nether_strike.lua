...
function nether_strike:OnSpellStart()
    ...
    if self:GetAutoCastState() then
        ...
        local particle = ParticleManager:SafeCreateParticle("particles/units/heroes/hero_spirit_breaker/spirit_breaker_greater_bash.vpcf" , PATTACH_CENTER_FOLLOW,target)
...
function modifier_nether_strike_illusions:OnCreated(tg)
    ...
    local particle = ParticleManager:SafeCreateParticle("particles/econ/items/spirit_breaker/spirit_breaker_iron_surge/spirit_breaker_charge_iron.vpcf", PATTACH_ABSORIGIN_FOLLOW, self.parent)
