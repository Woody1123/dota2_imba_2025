...
function modifier_bulldoze_buff:OnCreated()
    ...
    if IsServer() then   
        local particle = ParticleManager:SafeCreateParticleForPlayer("particles/units/heroes/hero_spirit_breaker/spirit_breaker_haste_owner.vpcf" , PATTACH_ABSORIGIN_FOLLOW, self.parent,self.caster:GetPlayerOwner())
...
function modifier_bulldoze_buff1:CheckState() 	
    return {
