...
function down:OnSpellStart()
	...
	caster:AddNewModifier(caster, self, "down_buff", {duration = duration})
end
...
function down_buff:OnCreated(keys)
	...
	self:GetCaster():StartGestureWithPlaybackRate(ACT_DOTA_CAST_ABILITY_4,0.54/self:GetDuration())
	end
end
