...
function smoke_bomb:OnSpellStart()
	...
	stone:AddNewModifier(caster, self, "modifier_ambush_motion",{duration = dur, pos_x = pos.x, pos_y = pos.y, pos_z = pos.z, dis = distance,height = height,damage = damage,impact_radius = impact_radius})
