...
function item_imba_mist_relics_passive:GetModifierStatusResistanceStacking()
...
function item_imba_satanic_passive:GetModifierStatusResistanceStacking()
	return self.statu
end
...
function item_imba_thirst_passive:GetModifierStatusResistanceStacking()
	return self.statu
end
