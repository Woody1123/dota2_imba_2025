...
function item_imba_aegis_heart:OnSpellStart()
	...
	local particle = ParticleManager:SafeCreateParticle("particles/neutral_fx/roshan_spawn.vpcf", PATTACH_POINT, caster)
	ParticleManager:SetParticleControl(particle, 0, caster:GetAbsOrigin())
	ParticleManager:SetParticleControl(particle, 1, caster:GetAbsOrigin())
	ParticleManager:ReleaseParticleIndex(particle)
	local pfx = ParticleManager:SafeCreateParticle("particles/neutral_fx/roshan_slam.vpcf", PATTACH_POINT, caster)
	ParticleManager:SetParticleControl(particle, 0, caster:GetAbsOrigin())
	ParticleManager:SetParticleControl(particle, 1, caster:GetAbsOrigin())
...
function modifier_imba_aegis_heart_passive:GetModifierHealthBonus()
	return self.hp2
end
