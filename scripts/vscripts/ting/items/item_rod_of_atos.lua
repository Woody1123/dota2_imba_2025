...
function modifier_item_imba_atos_root_v1:CheckState() return {[MODIFIER_STATE_TETHERED] = true,}end
...
function modifier_item_imba_atos_roo_shackle:OnCreated()
	...
	self.parent = self:GetParent()
		local particle = ParticleManager:SafeCreateParticle("particles/econ/items/shadow_shaman/ss_fall20_tongue/shadowshaman_shackle_net_fall20.vpcf", PATTACH_CUSTOMORIGIN_FOLLOW, self:GetParent())
