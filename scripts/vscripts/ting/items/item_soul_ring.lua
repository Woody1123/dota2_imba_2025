...
function modifier_imba_soul_ring_passive:DeclareFunctions() return {MODIFIER_PROPERTY_IGNORE_CAST_ANGLE,MODIFIER_EVENT_ON_HEAL_RECEIVED,MODIFIER_EVENT_ON_TAKEDAMAGE,MODIFIER_PROPERTY_HEALTH_REGEN_CONSTANT,MODIFIER_PROPERTY_SPELL_AMPLIFY_PERCENTAGE,MODIFIER_PROPERTY_MANACOST_PERCENTAGE,MODIFIER_PROPERTY_CASTTIME_PERCENTAGE,MODIFIER_PROPERTY_STATS_INTELLECT_BONUS}
end
function modifier_imba_soul_ring_passive:GetModifierIgnoreCastAngle()
    return 1
end
