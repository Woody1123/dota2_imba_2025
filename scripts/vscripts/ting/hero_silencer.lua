...
function modifier_imba_silencer_glaives_of_wisdom:steal(target)
	...
	local pfx1 = ParticleManager:SafeCreateParticle("particles/units/heroes/hero_silencer/silencer_last_word_steal_count.vpcf", PATTACH_OVERHEAD_FOLLOW, self.caster)
	...
	local pfx2 = ParticleManager:SafeCreateParticle("particles/units/heroes/hero_silencer/silencer_last_word_victim_count.vpcf", PATTACH_OVERHEAD_FOLLOW, target)
